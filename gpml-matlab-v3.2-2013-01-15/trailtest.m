...
d2014111 = 1;
if d2014111 > 0
    datastr{end+1} = 'data_cylinder90.txt'; %'data_201208_QM.txt'; %'test1-14.txt';
    results1str{end+1} = 'results_cylinder90.txt';
...
[hyp] = calculatehyp2(data,results1,index,groundtruth,gpiter,cutoff,leave);
