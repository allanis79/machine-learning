...
if d2014111 > 0
    ...
    results1str{end+1} = 'results_201411_shake2.txt';
    res2index = [res2index 2];  %Pick which Y value to use (2 is default for most)
end
 d2014112 = 0;
if d2014112 > 0
    datastr{end+1} = 'data_driller.txt'; %'data_201208_QM.txt'; %'test1-14.txt';
    results1str{end+1} = 'results_driller.txt';
    res2index = [res2index 2];  %Pick which Y value to use (2 is default for most)
 end
